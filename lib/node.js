...
module.exports = class Node {
   ...
   * @param is_client
   */
  constructor(socket, dataHandler, { id, metadata, host, port, is_client }) {
    this.id = id;
  ...
  static createFromClientSocket(dataHandler, socket, handshakeResponse) {
    return new Node(socket, dataHandler, {
      id: handshakeResponse.id,
      metadata: handshakeResponse.metadata,
