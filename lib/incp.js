...
class INCP extends events.EventEmitter {
  ...
  constructor(configuration = {}) {
    ...
    this[$CONFIGURATION].on('configuration-change', (property) => this._configurationChange(property));
  ...
  connectTo(port, host = '127.0.0.1', options = {}) {
    ...
    const promise = connect.call(this);
    ...
    async function connect() {
      ...
      const response = await client.getSocket().dataHandler.request({
        method: 'handshake',
        data: {
